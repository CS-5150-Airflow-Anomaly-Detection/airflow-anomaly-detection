...
type Props = {
  readonly anomalousDagRunKeys?: Set<string>;
  readonly dag: DAGWithLatestDagRunsResponse;
};

export const DagCard = ({ anomalousDagRunKeys = new Set(), dag }: Props) => {
            ...
            <Link asChild color="fg.info">
              <RouterLink to={`/dags/${latestRun.dag_id}/runs/${latestRun.run_id}`}>
                <DagRunInfo
                  ...
                  isAnomalous={anomalousDagRunKeys.has(`${dag.dag_id}::${latestRun.run_id}`)}
