...
export class DagAnomalyService {
    /**
     * Get Dag Anomalies
     ...
     * @throws ApiError
     */
    public static getDagAnomalies(data: GetDagAnomaliesData = {}): CancelablePromise<GetDagAnomaliesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/dag_anomaly',
            query: {
                dag_id: data.dagId,
                limit: data.limit,
                offset: data.offset
...
export class TaskInstanceAnomalyService {
    /**
     ...
     * @throws ApiError
     */
    public static getTaskInstanceAnomalies(data: GetTaskInstanceAnomaliesData = {}): CancelablePromise<GetTaskInstanceAnomaliesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/task_instance_anomaly',
            query: {
                dag_id: data.dagId,
                task_id: data.taskId,
                run_id: data.runId,
