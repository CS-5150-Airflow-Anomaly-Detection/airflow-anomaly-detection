...
* @throws ApiError
*/
export const ensureUseDagAnomalyServiceGetDagAnomaliesData = (queryClient: QueryClient, { dagId, limit, offset }: {
  dagId?: string;
  limit?: number;
  offset?: number;
} = {}) => queryClient.ensureQueryData({ queryKey: Common.UseDagAnomalyServiceGetDagAnomaliesKeyFn({ dagId, limit, offset }), queryFn: () => DagAnomalyService.getDagAnomalies({ dagId, limit, offset }) });
/**
...
* @throws ApiError
*/
export const ensureUseTaskInstanceAnomalyServiceGetTaskInstanceAnomaliesData = (queryClient: QueryClient, { dagId, limit, offset, runId, taskId }: {
  dagId?: string;
  limit?: number;
  offset?: number;
  runId?: string;
  taskId?: string;
} = {}) => queryClient.ensureQueryData({ queryKey: Common.UseTaskInstanceAnomalyServiceGetTaskInstanceAnomaliesKeyFn({ dagId, limit, offset, runId, taskId }), queryFn: () => TaskInstanceAnomalyService.getTaskInstanceAnomalies({ dagId, limit, offset, runId, taskId }) });
/**
* Get Health
