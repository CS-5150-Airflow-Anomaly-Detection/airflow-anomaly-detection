...
* @throws ApiError
*/
export const useDagAnomalyServiceGetDagAnomalies = <TData = Common.DagAnomalyServiceGetDagAnomaliesDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ dagId, limit, offset }: {
  dagId?: string;
  limit?: number;
  offset?: number;
} = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseDagAnomalyServiceGetDagAnomaliesKeyFn({ dagId, limit, offset }, queryKey), queryFn: () => DagAnomalyService.getDagAnomalies({ dagId, limit, offset }) as TData, ...options });
/**
...
* @throws ApiError
*/
export const useTaskInstanceAnomalyServiceGetTaskInstanceAnomalies = <TData = Common.TaskInstanceAnomalyServiceGetTaskInstanceAnomaliesDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ dagId, limit, offset, runId, taskId }: {
  dagId?: string;
  limit?: number;
  offset?: number;
  runId?: string;
  taskId?: string;
} = {}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseTaskInstanceAnomalyServiceGetTaskInstanceAnomaliesKeyFn({ dagId, limit, offset, runId, taskId }, queryKey), queryFn: () => TaskInstanceAnomalyService.getTaskInstanceAnomalies({ dagId, limit, offset, runId, taskId }) as TData, ...options });
/**
* Get Health
