...
* @throws ApiError
*/
export const useDagAnomalyServiceGetDagAnomaliesSuspense = <TData = Common.DagAnomalyServiceGetDagAnomaliesDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ dagId, limit, offset }: {
  dagId?: string;
  limit?: number;
  offset?: number;
