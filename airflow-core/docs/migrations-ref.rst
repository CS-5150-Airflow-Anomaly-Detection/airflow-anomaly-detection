...
+=========================+==================+===================+==============================================================+
| ``f1d4a3d8c9e2`` (head) | ``c7f2cf4d20b1`` | ``3.2.0``         | Backfill task instance anomaly runtime fields.               |
+-------------------------+------------------+-------------------+--------------------------------------------------------------+
| ``c7f2cf4d20b1``        | ``438ed3578bfb`` | ``3.2.0``         | Add missing task instance anomaly columns.                   |
+-------------------------+------------------+-------------------+--------------------------------------------------------------+
| ``438ed3578bfb``        | ``7e8e6d53a4b2`` | ``3.2.0``         | Add task instance anomaly table.                             |
+-------------------------+------------------+-------------------+--------------------------------------------------------------+
| ``7e8e6d53a4b2``        | ``53ff648b8a26`` | ``3.2.0``         | Add dag_run_anomaly table.                                   |
+-------------------------+------------------+-------------------+--------------------------------------------------------------+
